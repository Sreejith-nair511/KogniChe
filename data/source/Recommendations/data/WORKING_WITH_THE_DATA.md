...
**28,630 rows across 15 tables**, of which 13 are the tables your
...
Or open `data/APS-04.db` in any SQLite client. Nothing to install, nothing to import.
...
In `APS-04.db` the money columns are declared `TEXT`. That is deliberate: SQLite's NUMERIC
...
```bash
python3 tools/validate_conformance.py data/APS-04.db     # or point it at your own export
```
