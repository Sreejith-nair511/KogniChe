...
3. `data/queries/starter_queries.sql` — run them against `data/APS-04.db`. Ten minutes of running real queries will change what you design.
...
```
<TeamName>_APS-04_Design_v1.pdf
<TeamName>_APS-04_Wireframes.pdf
<TeamName>_APS-04_Architecture.drawio
```
...
3. Confirm the problem statement shown is APS-04. If it is not, stop and contact the organisers — do not upload.
